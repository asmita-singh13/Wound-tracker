...
model.load_weights('./static/resnet50deeplabv3_weights.h5')
...
# # Image overlay with mask boundary
...
#     cv2.drawContours(overlayed_image, contours, -1, (0, 0, 255), 2)  # Blue boundary
